...
func (r *oauthProxy) newOpenIDClient() (*OIDCClient, OIDCProviderConfig, *http.Client, error) {
	var err error
	...
	go func() {
		for {
			...
			if config, err = FetchProviderConfig(hc, r.config.DiscoveryURL); err == nil {
